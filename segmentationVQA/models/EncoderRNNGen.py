...
class EncoderRNNGen(BaseRNN):
    ...
    def __init__(self, vocab_size, max_len, hidden_size,
        ...
        super(EncoderRNNGen, self).__init__(vocab_size, max_len, hidden_size,
    ...
    def forward(self, input_var, input_lengths=None, h0=None):
        ...
        feature = output.contiguous().view(-1, self.hidden_size*2)
        feature = self.W_h(feature)
        return output, hidden, feature
