...
def store_features(dataset, image_ids, train_loc, val_loc):
    ...
    for i, image_id in enumerate(image_ids):
        path = "COCO_val2014_000000" + str(image_id).zfill(12) + '.jpg'
        try:
...
if __name__=='__main__':
    ...
    parser.add_argument('--train-annotations', type=str,
                        default='/data/junwon/v2_mscoco_train2014_annotations.json')
    parser.add_argument('--val-annotations', type=str,
                        default='/data/junwon/v2_mscoco_val2014_annotations.json')
    parser.add_argument('--train-questions', type=str,
           default='/data/junwon/v2_OpenEnded_mscoco_train2014_questions.json')
    parser.add_argument('--val-questions', type=str,
           default='/data/junwon/v2_OpenEnded_mscoco_val2014_questions.json')

    # MSCOCO images.
    parser.add_argument('--train-images', type=str,
                        default='/data/junwon/train2014')
    parser.add_argument('--val-images', type=str,
                        default='/data/junwon/val2014')

    # HDF5 outputs.
    parser.add_argument('--top-answers', type=str,
                        default='./vqa_top_answers.json',
                        help='Path for vocabulary wrapper.')
    parser.add_argument('--vocab', type=str,
                        default='./vocab_vqa_multi.json',
                        help='Path for vocabulary wrapper.')
    parser.add_argument('--train-output', type=str,
                        default='./vqa_multi_dataset.hdf5',
                        help='Training output.')
    parser.add_argument('--val-output', type=str,
                        default='./vqa_val_multi_dataset.hdf5',
