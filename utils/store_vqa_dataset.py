...
def get_qas(questions, annotations):
    qmap = {}
    output = []
...
if __name__=='__main__':
    ...
    parser.add_argument('--train-image-ids', type=str,
                        default='data/processed/vqa_train_image_ids.json',
                        help='Train image ids.')
    parser.add_argument('--val-image-ids', type=str,
                        default='data/processed/vqa_val_image_ids.json',
    ...
    parser.add_argument('--val-output', type=str,
                        default='data/processed/vqa_val_dataset.hdf5',
    ...
    train_qas = get_qas(train_questions, train_annotations)
    ...
    json.dump(train_image_ids, open(args.train_image_ids, 'w'))
    ...
    val_qas = get_qas(val_questions, val_annotations)
    ...
    json.dump(val_image_ids, open(args.val_image_ids, 'w'))
